 ...
 *
 * Wrapped in React cache() so it's memoized for the duration of a single
 * server request: <Nav> and the page body (and requireUser/requireAdmin) can
 * all call it while paying for only one auth.getUser() round-trip + profile
